...
export const StreamDeviceInfo: React.FC<StreamDeviceInfoProps> = ({ session }) => {
  return (
    <div className="space-y-2 bg-muted/30 dark:bg-muted/20 p-3 rounded-md border border-border/50">
      <h4 className="text-sm font-semibold text-foreground/90 dark:text-foreground mb-2">Device Information</h4>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
        <div className="flex items-center gap-2 bg-card p-2 rounded-md border border-border/30 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <div className="font-semibold text-foreground/80 dark:text-foreground/70">Platform</div>
        ...
        <div className="flex items-center gap-2 bg-card p-2 rounded-md border border-border/30 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <div className="font-semibold text-foreground/80 dark:text-foreground/70">Location</div>
            <div className="truncate text-foreground/60 dark:text-foreground/50 font-medium">
              <ClickableIP
        ...
        <div className="flex items-center gap-2 bg-card p-2 rounded-md border border-border/30 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <div className="font-semibold text-foreground/80 dark:text-foreground/70">Product</div>
            <div className="truncate text-foreground/60 dark:text-foreground/50 font-medium">
        ...
        <div className="flex items-center gap-2 bg-card p-2 rounded-md border border-border/30 min-w-0">
          ...
          <div className="min-w-0 flex-1">
            <div className="font-semibold text-foreground/80 dark:text-foreground/70">Streams Started</div>
            <div className="truncate text-foreground/60 dark:text-foreground/50 font-medium">
