...
export const ERROR_DISPLAY_CONFIG: Record<PlexErrorCode, ErrorDisplayConfig> = {
  ...
  [PlexErrorCode.INVALID_CONFIG]: {
    ...
    description: 'Your Plex configuration is incomplete or invalid. Please check your settings.',
    iconName: 'Settings',
    iconColor: 'text-amber-600 dark:text-amber-400',
    iconBg: 'bg-amber-100 dark:bg-amber-900/20',
    showChecklist: true
  ...
  [PlexErrorCode.NETWORK_ERROR]: {
    title: 'Network Error',
    description: 'A network error occurred while connecting to Plex. Please check your connection and try again.',
    iconName: 'WifiOff',
    iconColor: 'text-red-600 dark:text-red-400',
    iconBg: 'bg-red-100 dark:bg-red-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.INVALID_TOKEN]: {
    title: 'Invalid Token',
    description: 'Your Plex token is invalid. Please get a new token from your Plex account settings.',
    iconName: 'Shield',
    iconColor: 'text-red-600 dark:text-red-400',
    iconBg: 'bg-red-100 dark:bg-red-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.UNAUTHORIZED]: {
    ...
    description: 'Access to the Plex server was denied. Check your authentication credentials.',
    iconName: 'Shield',
    iconColor: 'text-red-600 dark:text-red-400',
    iconBg: 'bg-red-100 dark:bg-red-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.SSL_ERROR]: {
    ...
    description: 'There\'s an SSL/TLS connection problem. Try disabling SSL or enabling \'Ignore SSL certificate errors\' in settings.',
    iconName: 'Shield',
    iconColor: 'text-orange-600 dark:text-orange-400',
    iconBg: 'bg-orange-100 dark:bg-orange-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.CERT_ERROR]: {
    ...
    description: 'SSL certificate validation failed. Enable \'Ignore SSL certificate errors\' or use HTTP instead of HTTPS.',
    iconName: 'Shield',
    iconColor: 'text-orange-600 dark:text-orange-400',
    iconBg: 'bg-orange-100 dark:bg-orange-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.SERVER_ERROR]: {
    title: 'Server Error',
    description: 'The Plex server returned an error. Please check your server status and try again.',
  ...
  [PlexErrorCode.UNKNOWN_ERROR]: {
    title: 'Unknown Error',
    description: 'An unexpected error occurred. Please try again or check the application logs.',
    iconName: 'AlertTriangle',
    iconColor: 'text-red-600 dark:text-red-400',
    iconBg: 'bg-red-100 dark:bg-red-900/20',
    showChecklist: false
  ...
  [PlexErrorCode.REQUEST_FAILED]: {
    ...
    description: 'The request to the Plex server failed. Please check your connection and try again.',
    iconName: 'AlertTriangle',
    iconColor: 'text-red-600 dark:text-red-400',
    iconBg: 'bg-red-100 dark:bg-red-900/20',
    showChecklist: false
